...
if (isset($_POST['update_language'])) {
	if (isset($_POST['language']) && $_POST['language'] != $_SESSION['language']) {
		
		submitJob('language', $_POST['language'], 'Language set to ' . $_POST['language'], '');
		playerSession('write', 'language', $_POST['language']);
	}
}
...
// GENERAL
$_language['language'] = buildLanguageSelect($_SESSION['language']);

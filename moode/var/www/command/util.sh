...
if [[ $1 = "set-language" ]]; then
	if [[ $2 = "English" ]]; then
		cp -rf /var/www/tpl/en_us/templates/* /var/www/templates
		cp -f /var/www/tpl/en_us/footer.php /var/www/footer.php
		cp -f /var/www/tpl/en_us/quickhelp.html /var/www/quickhelp.html
		cp -f /var/www/tpl/en_us/header.php /var/local/www/header.php
	elif [[ $2 = "简体中文" ]];  then
		cp -rf /var/www/tpl/zh_cn/templates/* /var/www/templates
		cp -f /var/www/tpl/zh_cn/footer.php /var/www/footer.php
		cp -f /var/www/tpl/zh_cn/quickhelp.html /var/www/quickhelp.html
		cp -f /var/www/tpl/zh_cn/header.php /var/local/www/header.php
	fi
	exit
fi

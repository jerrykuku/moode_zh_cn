...
<body onorientationchange="javascript:location.reload(true); void 0;">
	...
	<div id="menu-top" class="ui-header ui-bar-f ui-header-fixed slidedown" data-position="fixed" data-role="header" role="banner">
		...
		<div id="config-tabs" class="viewswitch-cfgs hide">
			<a id="lib-config-btn" class="btn" href="lib-config.php">曲库</a>
			<a id="snd-config-btn" class="btn" href="snd-config.php">音频</a>
		...
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="menu-settings">
				<?php if ($section == 'index') { ?>
					<li><a href="#configure-modal" data-toggle="modal"><i class="fas fa-cog sx"></i> 设置</a></li>
					<li class="context-menu menu-separator"><a href="#notarget" data-cmd="appearance"><i class="fas fa-eye sx"></i> 外观</a></li>
					<li><a href="blu-config.php"><i class="fas fa-wifi sx"></i> 蓝牙</a></li>
					<li><a href="javascript:$('#players-modal .modal-body').load('players.php',function(e){$('#players-modal').modal('show');}); void 0"><i class="fas fa-forward sx"></i> 播放器</a></li>
					<li><a href="javascript:$('#audioinfo-modal .modal-body').load('audioinfo.php',function(e){$('#audioinfo-modal').modal('show');}); void 0"><i class="fas fa-music sx"></i> 音频信息</a></li>
					<li class="context-menu"><a href="#notarget" data-cmd="viewplayhistory"><i class="fas fa-book sx"></i> 播放历史</a></li>
					<li class="context-menu"><a href="#notarget" data-cmd="quickhelp"><i class="fas fa-info sx"></i> 快速帮助</a></li-->
					<li class="context-menu menu-separator"><a href="javascript:location.reload(true); void 0"><i class="fas fa-redo sx"></i> 刷新</a></li>
					<li><a href="#restart-modal" data-toggle="modal"><i class="fas fa-power-off sx"></i> 重启</a></li>
				<?php } else { ?>
					<li class="context-menu menu-separator"><a href="#configure-modal" data-toggle="modal"><i class="fas fa-cog sx"></i> 设置</a></li>
					<li><a href="javascript:$('#audioinfo-modal .modal-body').load('audioinfo.php',function(e){$('#audioinfo-modal').modal('show');}); void 0"><i class="fas fa-music sx"></i> 音频信息</a></li>
					<li><a href="javascript:$('#sysinfo-modal .modal-body').load('sysinfo.php',function(e){$('#sysinfo-modal').modal('show');}); void 0"><i class="fas fa-file-alt sx"></i> 系统信息</a></li>
